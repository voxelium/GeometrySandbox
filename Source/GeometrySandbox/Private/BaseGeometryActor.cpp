...
//     Super::BeginPlay();
//
//     UE_LOG(LogTemp, Display, TEXT("Привет Unreal"));
//     UE_LOG(LogTemp, Warning, TEXT("Привет Unreal"));
//     UE_LOG(LogTemp, Error, TEXT("Привет Unreal"));
//
...
//         break;
//
//         case EMovementType1::Static: break;
//         default: break;
//     }
// }
//
